...
int flag=0;
int n=0,s=0,p=0;
 int store1,store2,sub,sub2,storemodule,datamodule,store2module;
...
int Test::modulaus(QString m)
{

    if(p==0)
    {
     storemodule = m.toInt();
     datamodule=storemodule;
     p=1;
    }
   else
    {
         store2module = m.toInt();
     datamodule=datamodule / store2module;
...
void Test::distroying()
{
    data_=0,data1=1,datam=0,datadiv=1;
     n=0,s=0;
      ...
      storemodule=0,datamodule=0,p=0;
}
